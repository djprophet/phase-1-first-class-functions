function Monday(Alpha ,Beta) {
    console.log("Go for a five-mile run");
    console.log("Pump iron");
  }

  Monday(Alpha = "a", Beta = "b")
...
// Inline Functions are anoymous functions that are invoke without declaring a variable 
//Assigning in functions and variables are different 
